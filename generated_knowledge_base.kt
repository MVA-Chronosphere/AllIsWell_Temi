private val qaDatabase = listOf(
    ...
    KnowledgeBaseQA(
        ...
        answer = "The hospital provides cashless and reimbursement facilities through a wide range of trusted health insurance providers to ensure convenient and hassle-free treatment for patients. The accepted insurance companies include Star Health Insurance, Care Health Insurance, Paramount Health Services, IFFCO-Tokio General Insurance, Digit Insurance, Aditya Birla Health Insurance, SBI General Insurance, ICICI Lombard, FHPL (Family Health Plan Limited), MDIndia Healthcare Services, Niva Bupa Health Insur...",
    ...
    KnowledgeBaseQA(
        ...
        answer = "At All Is Well Hospital, we offer a variety of specially designed health check-up packages to meet the preventive and diagnostic healthcare needs of adults, women, children, and patients managing chronic conditions such as diabetes. Currently, we provide five major health packages: Basic Wellness, Comprehensive Wellness, Comprehensive Women Wellness, Diabetic Wellness, and Healthy Child Wellness. Each package includes a carefully selected combination of laboratory tests and diagnostic evaluat...",
    ...
    KnowledgeBaseQA(
        ...
        answer = "At All Is Well Hospital, the Radiology and Imaging Department offers a wide range of advanced diagnostic imaging services. The exact cost of each test depends on the type of scan, body part examined, contrast usage, and clinical requirements. Patients are advised to contact the billing counter for updated pricing.
The available radiology and imaging services include:
X-Ray: A quick and painless imaging test used to examine bones, chest, lungs, fractures, infections, and joint conditions. Char...",
...
Yes, walk-in consultations are generally allowed, depending on doctor availability. Patients can visit the hospital directly and register at the reception desk for an ...",
    ...
    KnowledgeBaseQA(
        ...
        answer = "You can reach the hospital via email at frontdesk@alliswellhospital.com. This email address is monitored by the hospital’s administrative team and can be used for general inquiries, appointment requests, health package details, feedback, or non-urgent medical coordination. When sending an email, it is recommended to include your name, contact number, and a brief description of your query to receive a quicker response.",
    ...
    KnowledgeBaseQA(
        id = "qa_125",
        question = "Is there a dedicated family lounge or waiting area?",
        answer = "Yes, we have comfortable waiting areas and a dedicated family lounge near the main lobby for visitors to rest while patients receive care.",
        keywords = listOf("comfortable", "care", "rest", "family", "receive", "patients", "near", "dedicated", "waiting", "visitors"),
        category = "general",
        language = "en"
    ),
    KnowledgeBaseQA(
